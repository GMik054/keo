...
const AfterSignInAccount = ({open}) => {
    let dispatch = useDispatch();
    return (
        <div className='onhover-div profile-dropdown' style={open?{opacity: "1", visibility: "visible",minWidth: "300px"}:{opacity: "0", visibility: "hidden",minWidth: "300px"}}>
