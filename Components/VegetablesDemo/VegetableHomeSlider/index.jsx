...
const VegetableHomeSlider = ({ mainSlider,slider }) => {
  ...
  return (
    <section className='pt-0 home-section home-section-6'>
      <VegetablePoster VegetableSlider={VegetableSlider} nav2={nav2} slider1={slider1} slider={slider}/>
      ...
      {/*<VegeLeftContain VegetableSlider={VegetableSlider} slider={slider}/>*/}
    </section>
  );
};
